...
function show() {
    ...
    var html = '<ul>';
    /*this displays a task to the list in the order it is inputed*/
...
/*this function removes a task when clicking on the x button*/
function remove() {
    var id = this.getAttribute('id');
    var todos = get_todos();
    todos.splice(id, 1);
    localStorage.setItem('todo', JSON.stringify(todos));
    /*this tells the show() how to display a removed item on the screen */
    show();
