...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some (element => element.includes(squareNumber))) {
        ...
        if (activePlayer==='X') {
            ...
            //active player may only be 'X' or 'O' so, so if not one, must be other
        } else {
            //if activePlayer is equal to 'O', the o.png is placed in HTML
            select.style.backgroundImage='url("images/rose.png")';
        }
...
function computersTurn() {
    ...
    while(!success) {
        ...
        if (placeXOrO(pickASquare)) {
            ...
            //this changes our booleam and ends the loop
            success=true;
        };
    }
}
...
//this function parses the selctedSquares array to search for win conditions
...
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //if 3 variables we pass are all included in our array, true is
...
function disableClick() {
    ...
    //this makes our body style clickable again after 1 second
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //this line gives us access to methods and propertires to use on canvas
    ...
    //this line indicates where the start of a lines y axis is
        ...
        audio('./media/audience_cheer-[AudioTrimmer.com].mp3');
