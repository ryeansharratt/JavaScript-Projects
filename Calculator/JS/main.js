...
const Calculator = {
    //diplays 0 on the screen
    Display_Value: '0',
    //will hold the first operand for any expressions, set to null for now
    First_Operand: null,
    //checks whether or not the second operand has been input
    Wait_Second_Operand: false,
    //will hold the operator, set to null for now
    operator: null,
};
...
function Input_Digit(digit) {
    ...
    //checking if Wait_Second_Operand is true and set
...
function Calculator_Reset() {
    ...
    Update_Display() ;
        ...
        keys.addEventListener('click', (event) => {
            ...
            //ensures that AC clears the numbers away
